...
app.get("/random/", (req, res) => {
  try {
    ...
    // Get the random joke object from the array
    const randomJoke = jokes[randomIndex];

    // Check if the randomJoke is defined (safeguard against jokes array being empty)
    if (!randomJoke) {
      throw new Error("No jokes available.");
    }
    ...
    // Handle errors
    console.error("Error generating random joke:", err);
